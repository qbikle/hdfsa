...
export default function Sidebar({ notes, username, email }: { notes: Note[]; username: string; email: string }) {
  return (
    <div className="flex flex-col h-full lg:w-80">
      <div className="flex justify-between w-screen lg:w-80 lg:flex-col lg:space-y-4 lg:min-h-screen lg:border lg:rounded-xl">
        ...
        <div className="flex items-center space-x-2 p-4">
          <button className="md:px-4 px-2 py-2 text-sm lg:text-lg text-blue-600 font-semibold underline bg-transparent rounded-md hover:bg-gray-200 transition-all ease-in-out duration-200 lg:w-full lg:bg-blue-600 lg:text-white lg:no-underline lg:hover:bg-blue-800">
            Sign Out
          </button>
        </div>
      </div>

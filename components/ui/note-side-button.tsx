...
export default function NoteSideButton({note}: {note: Note}) {
  return (
    <div className='flex w-full shadow-xl rounded-xl' >
      <button className="w-full flex  justify-start items-center border-t border-l border-b rounded-l-xl px-5 py-3 hover:bg-gray-200 transition-all ease-in-out duration-200">
        {note.title}
